	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Place']))
		{
			$model->attributes=$_POST['Place'];
                        ...
                        $fecha = date('YmdHms');
                        $model->image->saveAs(Yii::app()->basePath.'/../images/uploads/'.$fecha.'_'.$model->image);
                        $model->image = 'http://www.zp7738.tld.122.155.18.18.no-domain.name/smiletrip/images/uploads/'.$fecha.'_'.$model->image;     
			if($model->save())
